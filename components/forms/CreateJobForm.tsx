...
import { createJob } from "@/app/utils/api-actions";
...
export function CreateJobForm({
  ...
  async function onSubmit(values: z.infer<typeof jobSchema>) {
    try {
      ...
      const jobId = await createJob(values);
      ...
      // Redirect to Stripe payment immediately (no success message yet)
      console.log("Redirecting to payment page...");
      window.location.href = `/payment/checkout?jobId=${jobId}`;
    } catch (error: any) {
